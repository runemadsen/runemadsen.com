...
function fileUploaded(contents, filename) {
  ...
  if (!width || !height)
    return error("SVG must have width and height attribute");

  // Create form
  var tmpl =
    "<form>" +
    '<label>Width</label> <input id="inputWidth" name="width" value="' +
    width +
    '" type="text">' +
    '<label>Height</label> <input id="inputHeight" name="height" value="' +
    height +
    '" type="text" disabled>' +
